          ...
          return SafeArea(
            ...
            Header(
              ...
              widgetToShow: Column(
                ...
                children:[
                  new Text('Recuperar mi contraseña', style: subtituloblanco,),
                  SizedBox(height:20),
                  Obx(()=>
                    DotStepper(
                      ...
                      onDotTapped: (tappedDotIndex) {
                          _ctrl.activeStep.value = tappedDotIndex;
                      },
              ...
              TextButton.icon(
                ...
                icon: Icon(LineIcons.arrowLeft, color: color500,), 
                label: new Text('Atrás', style: body1,)
              )
            ])
          );
        },
    ...
    return Form(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
          children:[
            new Text('Ingresa tu correo electrónico', style: subtitulo,),

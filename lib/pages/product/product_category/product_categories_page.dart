...
class ProductsCategoryPage extends GetView<ProductCategoriesCtrl> {
                            ...
                            SliverGrid(
                              ...
                              delegate: SliverChildBuilderDelegate(
                                (BuildContext context, int index) {
                                  return myCards(
                                      category: _ctrl.productCategoryList
                                          .listProductCategory![index],
                                      index: index,
                                      context: context,
                                      ctrl: _ctrl);
                                },
                                childCount: _ctrl.productCategoryList
                                    .listProductCategory!.length,
                              ),
                            )
                          ]))),
        );
  ...
  Widget myCards(
      ...
      required ProductCategoriesCtrl ctrl}) {
    return FadeInLeft(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(category.description.toString(),
                    style: body1, textAlign: TextAlign.center),
                SizedBox(
                  height: 5,
                ),
              ],

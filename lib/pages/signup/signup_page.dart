          ...
          body: Form(
            ...
            child: ListView(
              children: <Widget>[
                ...
                new Text('Registrarme', style: subtitulo, textAlign: TextAlign.center),
                SizedBox(
                  height: 15,
                ),
                Padding(
                          ...
                          child: Column(
                            children:[
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  Text("Ya tengo una cuenta ", style: body1,),
                                  InkWell(
                                    onTap: ()=> Get.back(),
                                    child: Text("Iniciar sesión", style: TextStyle(color:color500, fontWeight: FontWeight.w500,fontSize: 12, decoration: TextDecoration.underline )),
                                  )
                                ],
                              ),
                            ]
